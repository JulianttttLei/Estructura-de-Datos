...
public class Diccionario {
    ...
    private void balancear(NodoAVLDicc nodo,NodoAVLDicc padre){
        ...
        NodoAVLDicc nodoAux=aplicaRotacion(nodo);
        if(nodo==this.raiz){
            this.raiz=nodoAux;
        }else{
    ...
    private NodoAVLDicc aplicaRotacion(NodoAVLDicc nodo){
    ...
    private int calculaBalance(NodoAVLDicc nodo){
        ...
        System.out.println("Nodo Balance: "+nodo.getClave());
        alturaHijoIzq=-1;
        alturaHijoDer=-1;
        if(nodo.getIzquierdo()!=null){
        ...
        System.out.println("Altura izq: "+alturaHijoIzq);
        System.out.println("Altura der: "+alturaHijoDer);
 ...
 private void eliminarCon2Hijos(NodoAVLDicc nodo){
 ...
 //CAMBIAR METODO DE ARBOL AVL DE LISTAR
...
// Este metodo genera y devuelve un arbol binario que es equivalente al arbol original
    ...
    private String obtenerToString(NodoAVLDicc nodo) {
        ...
        if (nodo != null) {
            ...
            cadena += " Clave: " + nodo.getClave()+ " con dato: " +nodo.getDato();
            if (nodo.getIzquierdo() != null) {

                cadena += " HI con Clave: " + nodo.getIzquierdo().getClave()+ 
                        " y dato: "+nodo.getIzquierdo().getDato();
            } else {
                cadena += " HI: " + null;
            }
            if (nodo.getDerecho() != null) {

                cadena += " | HD con Clave: " + nodo.getDerecho().getClave()+ 
                        " y dato: "+nodo.getDerecho().getDato()+" \n";
            } else {
                cadena += " | HD: " + null + "\n";
